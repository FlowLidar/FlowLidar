...
template<int bucket_num, int light_mem>
class ElasticSketch
{
...
public:
    ElasticSketch(bool flag){
        light_part.init(flag);
    }
    ~ElasticSketch(){}
    void clear()
    {
    ...
    int h_nonzero() 
	{
		return heavy_part.h_nonzero();		
	}
    int nonzero() 
	{
		return light_part.nonzero();		
	}
    int lightsize() 
	{
		return light_mem;		
    ...
    float sparse_load_factor() {
        return light_part.sparse_load_factor();
    } 
    int sparse_size() {
        return light_part.sparse_size();
    } 
    int sparse_nitem() {
        return light_part.sparse_nitem();
    } 
    int get_iterations() {
        return light_part.get_iterations();
    }

    int get_max_iterations() {
        return light_part.get_max_iterations();
    }
