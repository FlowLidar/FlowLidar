...
for j in range(1,4):
    for i in range(60):
        ...
        if os.stat("./data/CAIDA_trace_{}/1000ms/split_{}.bin".format(j,i)).st_size == 0:
            continue
        #print("./{} {} {} ./data/CAIDA_trace_{}/1000ms/split_{}.bin {} {} 2>&1".format(args.script, args.filter_memory, args.sketch_memory, j, i, args.filter_hash_nr, args.sketch_hash_nr))
        stream =  os.popen("./{} {} {} ./data/CAIDA_trace_{}/1000ms/split_{}.bin {} {} 2>&1".format(args.script,args.filter_memory,args.sketch_memory,j,i,args.filter_hash_nr, args.sketch_hash_nr))
        ...
        #print(i)
    print("Trace {}".format(j))
    print("zero_error %\taae\tare\tsent_keys")
    print("{}\t{}\t{}\t{}".format(np.array(zero_error_array).mean(), np.array(aae_array).mean(), np.array(are_array).mean(), np.array(sent_keys_array).mean()))
